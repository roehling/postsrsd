...
find_path(LibMilter_INCLUDE_DIR mfapi.h PATH_SUFFIXES libmilter HINTS ${PC_MILTER_INCLUDE_DIRS})
find_library(LibMilter_LIBRARY milter HINTS ${PC_MILTER_LIBRARY_DIRS})
find_package_handle_standard_args(LibMilter
...
if(LibMilter_FOUND AND NOT TARGET LibMilter::LibMilter)
    ...
    set_target_properties(LibMilter::LibMilter PROPERTIES
        IMPORTED_LOCATION "${LibMilter_LIBRARY}"
